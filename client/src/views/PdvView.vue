...
const {
  ...
  atingiuLimite,
  totalItemAtual,
  podeConfirmar: podeConfirmarProduto,
  resetState: resetProduto,
  calcularPeso,
  isSaborGroup,
  minEfetivoGrupo,
  ...
  selecionarUnico,
  montarPayload,
} = useProductBuilder(produtoDetalhado)
...
const confirmarItem = () => {
  ...
  carrinho.value.push(montarPayload())
